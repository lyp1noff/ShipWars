...
def bot_shot():
    ...
    if finding_part_of_ship == 1:
        if player_grid[prev_a][prev_b] == "[X]":
            while shot_offset == 1:
                random_offset = random.randint(1, 4)
                if random_offset == 1:
                    try:
                        if player_grid[prev_a + 1][prev_b] == "[B]":
                            player_grid[prev_a][prev_b] = "[X]"
                            visible_player_grid[prev_a][prev_b] = "[X]"
                            shot_offset = 0
                            hited = 1
                        else:
                            player_grid[prev_a + 1][prev_b] = "[0]"
                            visible_player_grid[prev_a][prev_b] = "[0]"
                            shot_offset = 0
                    except IndexError:
                        shot_offset = 1
                if random_offset == 2:
                ...
                if random_offset == 3:
                    try:
                        if player_grid[prev_a][prev_b - 1] == "[B]":
                            player_grid[prev_a][prev_b] = "[X]"
                            visible_player_grid[prev_a][prev_b] = "[X]"
                            shot_offset = 0
                            hited = 1
                        else:
                            player_grid[prev_a][prev_b - 1] = "[0]"
                            visible_player_grid[prev_a][prev_b] = "[0]"
                            shot_offset = 0
                    except IndexError:
                        shot_offset = 1
        ...
        if player_grid[a][b] == "[B]":
            ...
            if ships_near_shot >= 1:
                if ships_near_shot == 1:
                    try:
                        if player_grid[a][b - 1] == "[B]" and player_grid[a][b - 2] == "[B]" and player_grid[a][b - 3] == "[B]":
                            if visible_player_grid[a][b - 1] == "[X]" and visible_player_grid[a][b - 2] == "[X]" and visible_player_grid[a][b - 3] == "[X]":
                                kill = 1
                                try:
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 1][b + 1] == "[ ]" and visible_player_grid[a + 1][b + 1] == "[ ]":
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 1][b - 2] == "[ ]" and visible_player_grid[a + 1][b - 2] == "[ ]":
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 1][b - 3] == "[ ]" and visible_player_grid[a + 1][b - 3] == "[ ]":
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 1][b - 4] == "[ ]" and visible_player_grid[a + 1][b - 4] == "[ ]":
                    ...
                    try:
                        if player_grid[a][b + 1] == "[B]" and player_grid[a][b + 2] == "[B]" and player_grid[a][b + 3] != "[B]":
                            if visible_player_grid[a][b + 2] == "[X]" and visible_player_grid[a][b + 2] == "[X]":
                                if visible_player_grid[a][b] != "[X]":
                                    kill = 1
                                else:
                                    kill = 2
                    ...
                    try:
                        ...
                        k = 0
                    try:
                        if player_grid[a + 1][b] == "[B]" and player_grid[a + 2][b] == "[B]" and player_grid[a + 3][b] == "[B]":
                            if visible_player_grid[a + 1][b] == "[X]" and visible_player_grid[a + 2][b] == "[X]" and visible_player_grid[a + 3][b] == "[X]":
                                if visible_player_grid[a][b] != "[X]":
                                    kill = 1
                                else:
                                    kill = 2
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 2][b - 1] == "[ ]" and visible_player_grid[a + 2][b - 1] == "[ ]":
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 3][b - 1] == "[ ]" and visible_player_grid[a + 3][b - 1] == "[ ]":
                                ...
                                try:
                                    ...
                                    k = 0
                                try:
                                    if player_grid[a + 4][b - 1] == "[ ]" and visible_player_grid[a + 4][b - 1] == "[ ]":
                ...
                if ships_near_shot == 2:
                    try:
                        if player_grid[a - 1][b] == "[B]" and player_grid[a + 1][b] == "[B]"\
                                and visible_player_grid[a - 1][b] == "[X]" and visible_player_grid[a + 1][b] == "[X]":
                            if visible_player_grid[a][b] != "[X]":
                                kill = 1
                            else:
                                kill = 2
                            try:
                                if player_grid[a - 2][b] == "[B]" or player_grid[a + 2][b] == "[B]":
                                    if player_grid[a - 1][b] == "[B]":
                                        try:
                                            if player_grid[a - 3][b] == "[ ]" and visible_player_grid[a - 3][b] == "[ ]":
                                                visible_player_grid[a - 3][b] = "[0]"
                        ...
                        k = 0
                    try:
                        if player_grid[a][b - 1] == "[B]" and player_grid[a][b + 1] == "[B]"\
                                and visible_player_grid[a][b - 1] == "[X]" and visible_player_grid[a][b + 1] == "[X]":
                            if visible_player_grid[a][b] != "[X]":
                                kill = 1
                            else:
                                kill = 2
                            try:
                                if player_grid[a][b - 2] == "[B]" or player_grid[a][b + 2] == "[B]":
                                    if player_grid[a][b - 2] == "[B]":
                                        try:
                                            if player_grid[a][b - 3] == "[ ]" and visible_player_grid[a][b - 3] == "[ ]":
                                                visible_player_grid[a][b - 3] = "[0]"
                ...
                try:
                    ...
                    k = 0
                try:
                    if player_grid[a][b - 1] == "[ ]" or player_grid[a][b - 1] == "[ ]":
                        visible_player_grid[a][b - 1] = "[0]"
                except IndexError:
                    k = 0
                try:
                    ...
                    k = 0
                try:
                    if player_grid[a + 1][b - 1] == "[ ]" or player_grid[a + 1][b - 1] == "[ ]":
                        visible_player_grid[a + 1][b - 1] = "[0]"
                except IndexError:
                    k = 0
                try:
            ...
            if kill == 1:
                prev_shot_hited = 0
                if killed == 1:
                    print("Bot killed ship! There are", 10 - killed, "your ships left.")
                elif killed > 1:
                    print("Bot killed", killed, "ships! There are", 10 - killed, "your ships left.")
                killed += 1
            else:
                prev_shot_hited = 1
